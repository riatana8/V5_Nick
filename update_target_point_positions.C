    ...
    const double dt)
{
	...
	int nO_1st = 8;      //First Pt. of Peristaltic Region on OUTER
	int nO_2nd = 145;  //Last Pt. of Peristaltic Region on OUTER
	int nI_1st = 162;   //First Pt. of Peristaltic Region on INNER
	int nI_2nd = 299; //Last Pt. of Peristaltic Region on INNER
