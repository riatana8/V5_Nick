    ...
    const double dt)
{
	...
	static const int numPts = 155;//Number of Points in Bottom of Tube, changed from 155 4/20
	...
	int nO_2nd = 155;  //Last Pt. of Peristaltic Region on OUTER
	int nI_1st = 156;   //First Pt. of Peristaltic Region on INNER
	int nI_2nd = 308; //Last Pt. of Peristaltic Region on INNER
	...
	double x0 = X[9];		      //Left-Pt of Wave at INITIAL POSITION, changed from 31 4/20
	...
	double A_tilde = 4.8000e+01;   //"Fixed" Amplitude for Gaussian Wave
