    ...
    const double dt)
{
	...
	static const int numPts = 155;//Number of Points in Bottom of Tube
	...
	int nO_1st = 162;      //First Pt. of Peristaltic Region on OUTER
	int nO_2nd = 265;  //Last Pt. of Peristaltic Region on OUTER
	int nI_1st = 8;   //First Pt. of Peristaltic Region on INNER
	int nI_2nd = 111; //Last Pt. of Peristaltic Region on INNER
