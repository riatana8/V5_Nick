    ...
    const double dt)
{
	...
	int nO_1st = 155;      //First Pt. of Peristaltic Region on OUTER
	int nO_2nd = 308;  //Last Pt. of Peristaltic Region on OUTER
	int nI_1st = 0;   //First Pt. of Peristaltic Region on INNER
	int nI_2nd = 154; //Last Pt. of Peristaltic Region on INNER
